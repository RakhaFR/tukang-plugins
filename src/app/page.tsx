    ...
    <div style={{ fontFamily: BODY, background: "#111", color: "#f5f5f5", minHeight: "100vh", overflowX: "hidden" }}>
      ...
      {menuOpen && (
        <div className="mobile-menu" style={{
          ...
          display: "flex", flexDirection: "column", padding: "16px 24px 20px",
          gap: 4
        }}>
          {(["#fitur", "#plugin", "#sosial"] as const).map((href, i) => (
            <a
              ...
              style={{
                ...
                fontSize: "1rem", fontWeight: 500, padding: "10px 0",
                borderBottom: "1px solid rgba(255,255,255,0.05)"
              }}
            >
              {["Fitur", "Plugin", "Komunitas"][i]}
        ...
        <div className="hero-content" style={{ position: "relative", zIndex: 10, padding: "60px 40px 80px", maxWidth: 700, width: "100%" }}>
          <h1
            ...
            style={{
              ...
              lineHeight: 1, margin: "0 0 4px", color: "#fff",
              WebkitTextStroke: "4px #C0392B", paintOrder: "stroke fill",
            }}
          >
            TUKANG
          </h1>
          ...
          <h1
            ...
            style={{
              ...
              WebkitTextStroke: "4px #7A9600", paintOrder: "stroke fill",
            }}
          >
          ...
          <p
            ...
            data-aos-delay="500"
            className="hero-desc"
            style={{ fontSize: "0.95rem", lineHeight: 1.75, color: "rgba(255,255,255,0.65)", maxWidth: 420, marginBottom: 32 }}
          >
      ...
      <section id="fitur" style={{ background: "#161616", padding: "72px 24px" }}>
        <div style={{ maxWidth: 960, margin: "0 auto" }}>
          ...
          <h2 data-aos="fade-right" style={{ fontFamily: DISPLAY, fontSize: "clamp(1.8rem, 5vw, 3.8rem)", color: "#fff", margin: "0 0 48px", lineHeight: 1.1 }}>
          ...
          <div className="features-grid" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: 1, background: "rgba(255,255,255,0.06)" }}>
            {[
              ...
              <div
                ...
                style={{ background: "#161616", padding: "32px 28px", transition: "all 0.3s" }}
              >
      ...
      <section id="plugin" style={{ background: "#111", padding: "72px 24px" }}>
        <div style={{ maxWidth: 960, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", marginBottom: 36, flexWrap: "wrap", gap: 12 }}>
            <h2 data-aos="fade-right" style={{ fontFamily: DISPLAY, fontSize: "clamp(1.8rem, 5vw, 3.8rem)", color: "#fff", margin: 0, lineHeight: 1.1 }}>
              Terbaru dari Drive
            </h2>
            <Link
              href="/plugins"
      ...
      <section id="sosial" style={{ background: "#161616", padding: "72px 24px", borderTop: "1px solid rgba(255,255,255,0.03)" }}>
        <div style={{ maxWidth: 960, margin: "0 auto" }}>
          ...
          <h2 data-aos="fade-right" style={{ fontFamily: DISPLAY, fontSize: "clamp(1.8rem, 5vw, 3.8rem)", color: "#fff", margin: "0 0 12px", lineHeight: 1.1 }}>
            Komunitas & Sosial
          </h2>
      ...
      <section style={{ background: RED, padding: "72px 24px", textAlign: "center" }}>
        ...
        <h2
          data-aos="zoom-in"
          style={{ fontFamily: DISPLAY, fontSize: "clamp(1.8rem, 6vw, 4.5rem)", color: "#fff", margin: "0 0 14px", lineHeight: 1.1 }}
        >
      ...
      {previewFile && (
        ...
        >
          <div className="modal-header" style={{ width: '100%', maxWidth: 960, display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12, gap: 16 }}>
            <h3 style={{ fontWeight: 600, fontSize: '0.95rem', color: '#fff', margin: 0, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', flex: 1 }}>
              {previewFile.name}
            </h3>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexShrink: 0 }}>
              <a
                ...
                style={{
                  ...
                  fontSize: '0.75rem', padding: '8px 14px', display: 'flex', alignItems: 'center', gap: 6, transition: 'all 0.2s'
                }}
              >
          ...
          <div style={{
            width: '100%', maxWidth: 960, flex: 1, maxHeight: '80vh', backgroundColor: '#090909',
